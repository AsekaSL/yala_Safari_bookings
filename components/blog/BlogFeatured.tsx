            ...
            <div className="px-4 md:px-20 max-w-[1280px] mx-auto">
                <div className="flex flex-col md:flex-row gap-12 items-center">
                    <div className="flex-1 space-y-6">
                        <h2 className="text-primary text-3xl md:text-4xl font-bold font-display">More Than Just a Safari</h2>
                        ...
                        <div className="flex items-center gap-3 text-primary font-bold pt-2 cursor-pointer group w-fit">
