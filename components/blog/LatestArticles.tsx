    ...
    return (
        <div className="py-8 md:py-16 px-4 md:px-20 max-w-[1280px] mx-auto w-full">
            <div className="flex justify-between items-end mb-10">
                <h3 className="text-2xl md:text-3xl font-bold font-display text-[#1d1815]">Latest from the Field</h3>
                <a className="hidden md:flex text-[#5a3e2a] font-bold hover:text-[#FF914D] transition-colors" href="#">View Archive →</a>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <article className="flex flex-col gap-4 group cursor-pointer">
                    <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                        ...
                        <div className="absolute top-4 left-4">
                            <span className="bg-white/90 backdrop-blur-sm text-[#5a3e2a] text-xs font-bold px-3 py-1 rounded-md shadow-sm">Photography</span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <h4 className="text-xl font-bold font-display text-[#1d1815] group-hover:text-[#FF914D] transition-colors">Golden Hour in Yala: A Photographer's Guide</h4>
                        ...
                        <span className="text-[#5a3e2a] text-sm font-bold mt-1 inline-block border-b border-transparent group-hover:border-[#5a3e2a] w-fit">Read More</span>
                    </div>
                </article>
                ...
                <article className="flex flex-col gap-4 group cursor-pointer">
                    <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                        ...
                        ></div>
                        <div className="absolute top-4 left-4">
                            <span className="bg-white/90 backdrop-blur-sm text-[#5a3e2a] text-xs font-bold px-3 py-1 rounded-md shadow-sm">Deep Dive</span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-3 text-xs text-[#7e746d]">
                        ...
                        <h4 className="text-xl font-bold font-display text-[#1d1815] group-hover:text-[#FF914D] transition-colors">Understanding Elephant Emotions</h4>
                ...
                <article className="flex flex-col gap-4 group cursor-pointer">
                    <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                        ...
                        ></div>
                        <div className="absolute top-4 left-4">
                            <span className="bg-white/90 backdrop-blur-sm text-[#5a3e2a] text-xs font-bold px-3 py-1 rounded-md shadow-sm">Responsible Tourism</span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-3 text-xs text-[#7e746d]">
                        ...
                        <h4 className="text-xl font-bold font-display text-[#1d1815] group-hover:text-[#FF914D] transition-colors">The Impact of Ethical Jeeping</h4>
                ...
                <article className="flex flex-col gap-4 group cursor-pointer">
                    <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                        ...
                        ></div>
                        <div className="absolute top-4 left-4">
                            <span className="bg-white/90 backdrop-blur-sm text-[#5a3e2a] text-xs font-bold px-3 py-1 rounded-md shadow-sm">Planning</span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-3 text-xs text-[#7e746d]">
                        ...
                        <h4 className="text-xl font-bold font-display text-[#1d1815] group-hover:text-[#FF914D] transition-colors">Navigating the Blocks: Where to Go?</h4>
                ...
                <article className="flex flex-col gap-4 group cursor-pointer">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <h4 className="text-xl font-bold font-display text-[#1d1815] group-hover:text-[#FF914D] transition-colors">Reading the Jungle Floor</h4>
                ...
                <article className="flex flex-col gap-4 group cursor-pointer">
                    <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                        ...
                        ></div>
                        <div className="absolute top-4 left-4">
                            <span className="bg-white/90 backdrop-blur-sm text-[#5a3e2a] text-xs font-bold px-3 py-1 rounded-md shadow-sm">Experiences</span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-3 text-xs text-[#7e746d]">
                        ...
                        <h4 className="text-xl font-bold font-display text-[#1d1815] group-hover:text-[#FF914D] transition-colors">Packing for Your Safari Adventure</h4>
            ...
            <div className="mt-12 flex justify-center">
                <button className="px-8 py-3 bg-white border border-[#e3e0de] hover:border-[#5a3e2a] hover:text-[#5a3e2a] text-[#1d1815] font-bold rounded-lg transition-all shadow-sm hover:shadow-md">
                    Load More Articles
                </button>
            </div>
        </div>
