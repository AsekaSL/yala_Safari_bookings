                ...
                <div className="px-4 md:px-20 flex flex-1 justify-center">
                    <div className="layout-content-container flex flex-col max-w-[800px] flex-1 text-center items-center gap-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                            <Link href="/packages" className="cursor-pointer flex items-center justify-center rounded-lg h-12 px-8 bg-accent hover:bg-[#ff8030] text-white text-base font-bold transition-all shadow-lg hover:translate-y-[-2px]">
                                View Safari Packages
                            </Link>
                            <Link href="/safari-calculator" className="cursor-pointer flex items-center justify-center rounded-lg h-12 px-8 bg-white text-primary hover:bg-gray-100 text-base font-bold transition-all shadow-lg hover:translate-y-[-2px]">
                                Book a Jeep Safari
                            </Link>
