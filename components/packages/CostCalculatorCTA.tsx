            ...
            <div className="layout-container flex h-full grow flex-col relative z-10">
                <div className="px-4 md:px-20 flex flex-1 justify-center">
                    <div className="layout-content-container flex flex-col max-w-[800px] flex-1 text-center items-center gap-6">
                        <MdCalculate className="text-5xl text-[#FF914D]" />
                        ...
                        <button className="mt-4 flex min-w-[200px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-14 px-8 bg-[#FF914D] hover:bg-[#ff8030] text-white text-lg font-bold leading-normal tracking-[0.015em] transition-all shadow-lg hover:translate-y-[-2px]">
