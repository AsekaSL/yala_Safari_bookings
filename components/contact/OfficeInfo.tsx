    ...
    return (
        <div className="flex flex-col gap-6 pt-6 border-t border-[#e3e0de]">
            <div className="flex gap-4 items-start">
                <div className="size-12 shrink-0 rounded-full bg-background-light flex items-center justify-center text-[#7e746d]">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="space-y-3 text-sm text-[#5a5a5a]">
                        <div>
                            <strong className="text-primary block">Head Office:</strong>
                            2B, 1st Cross Street, Pagoda Road, Nugegoda, Sri Lanka
                        </div>
                        <div>
                            <strong className="text-primary block">Alternative Office:</strong>
