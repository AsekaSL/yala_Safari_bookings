                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-12">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex gap-4 mt-2">
                                    ...
                                    <a className="hover:text-white transition-colors" href="#"><span className="material-symbols-outlined">people</span></a>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <nav className="flex flex-col gap-2 text-sm">
                                    {
                                        navLinks.map((link) => (
                                            <Link key={link.href} className="hover:text-primary transition-colors" href={link.href}>{link.label}</Link>
                                        ))
                                    }
                                </nav>
                            </div>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <nav className="flex flex-col gap-2 text-sm">
                                    {
                                        blogs.map((blog) => (
                                            <Link key={blog.label} className="hover:text-primary transition-colors" href={blog.href}>{blog.label}</Link>
                                        ))
                                    }
                                </nav>
                            </div>
