...
export default function PhotoMasonry() {
    return (
        <div className="bg-background-light py-10 px-4 md:px-10">
            <div className={`max-w-[1440px] mx-auto ${styles.masonryGrid}`}>
                <div className={`relative group overflow-hidden rounded-xl shadow-md cursor-zoom-in ${styles.masonryItem}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <span className="text-accent text-xs font-bold uppercase tracking-wider mb-1">Elephants</span>
                ...
                <div className={`relative group overflow-hidden rounded-xl shadow-md cursor-zoom-in ${styles.masonryItem}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <span className="text-accent text-xs font-bold uppercase tracking-wider mb-1">Leopards</span>
                ...
                <div className={`relative group overflow-hidden rounded-xl shadow-md cursor-zoom-in ${styles.masonryItem}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <span className="text-accent text-xs font-bold uppercase tracking-wider mb-1">Landscapes</span>
                ...
                <div className={`relative group overflow-hidden rounded-xl shadow-md cursor-zoom-in ${styles.masonryItem}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <span className="text-accent text-xs font-bold uppercase tracking-wider mb-1">Birds</span>
                ...
                <div className={`relative group overflow-hidden rounded-xl shadow-md cursor-zoom-in ${styles.masonryItem}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <span className="text-accent text-xs font-bold uppercase tracking-wider mb-1">Safari Experience</span>
                ...
                <div className={`relative group overflow-hidden rounded-xl shadow-md cursor-zoom-in ${styles.masonryItem}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <span className="text-accent text-xs font-bold uppercase tracking-wider mb-1">Reptiles</span>
                        <h3 className="text-white text-lg font-display font-bold">Ancient Predator</h3>
                    </div>
                </div>
            </div>
            <div className="flex justify-center mt-12">
                <button className="border border-primary text-primary hover:bg-primary hover:text-white font-medium py-3 px-8 rounded-lg transition-colors duration-300 flex items-center gap-2">
                    Load More Photos
