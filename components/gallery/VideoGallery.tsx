...
export default function VideoGallery() {
    return (
        <div className="bg-[#1d1815] py-20 text-white relative">
            <div className="max-w-[1440px] mx-auto px-4 md:px-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div>
                        <span className="text-[#FF914D] text-sm font-bold uppercase tracking-widest block mb-2">Cinematic Experience</span>
                        <h2 className="text-3xl md:text-5xl font-display font-bold">Explore the Wild – Yala Safari Moments</h2>
                    </div>
                    <button className="text-[#7FB3C8] hover:text-white transition-colors flex items-center gap-2 text-sm font-medium">
                        View All Videos <MdArrowForward />
                    </button>
                </div>
                    ...
                    <div className="group relative rounded-xl overflow-hidden aspect-video bg-black/40 cursor-pointer">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="size-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/40">
                                <MdPlayArrow className="text-white text-3xl fill-current" />
                            </div>
                        </div>
