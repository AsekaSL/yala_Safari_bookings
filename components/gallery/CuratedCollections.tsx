    ...
    return (
        <div className="bg-white py-20 px-4 md:px-10">
            <div className="max-w-[1440px] mx-auto">
                <h2 className="text-3xl font-display font-bold text-[#5a3e2a] mb-10 text-center">Curated Collections</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <a className="group block" href="#">
                        ...
                        <h3 className="text-xl font-bold text-[#5a3e2a] mb-1 group-hover:text-[#FF914D] transition-colors">The Leopard of Yala</h3>
                    ...
                    <a className="group block" href="#">
                        ...
                        <h3 className="text-xl font-bold text-[#5a3e2a] mb-1 group-hover:text-[#FF914D] transition-colors">Giants at Waterholes</h3>
                    ...
                    <a className="group block" href="#">
                        ...
                        <h3 className="text-xl font-bold text-[#5a3e2a] mb-1 group-hover:text-[#FF914D] transition-colors">Birdlife of Yala</h3>
                    ...
                    <a className="group block" href="#">
                        ...
                        <h3 className="text-xl font-bold text-[#5a3e2a] mb-1 group-hover:text-[#FF914D] transition-colors">Sunrise & Sunset Magic</h3>
