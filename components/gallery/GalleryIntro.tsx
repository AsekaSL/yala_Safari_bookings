    ...
    return (
        <div className="bg-background-light py-16 md:py-20">
            <div className="max-w-3xl mx-auto px-6 text-center">
                <span className="material-symbols-outlined text-primary text-4xl mb-4">temp_preferences_custom</span>
                <p className="text-desert-brown text-lg md:text-xl leading-relaxed font-light mb-6">
