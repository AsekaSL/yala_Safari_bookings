                ...
                <div className="px-4 md:px-20 flex flex-1 justify-center">
                    <div className="layout-content-container flex flex-col max-w-[1280px] flex-1">
                        <div className="mb-10 text-center">
                            <h2 className="text-primary text-3xl font-bold font-display">Explore the Zones</h2>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full px-4 md:px-20 z-10">
                                ...
                                {/* Block 1 */}
                                <div className="bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg border-l-4 border-primary">
                                    <h4 className="font-bold text-primary">Block 1 (Main)</h4>
                                ...
                                <div className="bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg border-l-4 border-sky-blue">
                                    <div className="flex justify-between items-start">
                                        <h4 className="font-bold text-primary">Block 5</h4>
                                        <span className="bg-sky-blue text-white text-[10px] px-2 py-0.5 rounded-full">Quiet</span>
                                    </div>
                                ...
                                <div className="bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg border-l-4 border-green-600">
                                    <div className="flex justify-between items-start">
                                        <h4 className="font-bold text-primary">Lunugamwehera</h4>
